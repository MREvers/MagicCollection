...
JSONImporterTwo::JSONImporterTwo()
{
}
...
void 
JSONImporterTwo::ImportJSON( const std::string& aszFileName )
{
...
void 
JSONImporterTwo::importJSON( std::ifstream& aifstream ) 
{
   nlohmann::json j;
   aifstream >> j;
...
void 
JSONImporterTwo::importJSON( const nlohmann::json& ajson )
{
   // Prepare a data structure to help us load the json file
   auto mapCardDetails = new map<string, CardDetails*, JSONImporterTwo::sortFunc>();
...
void 
JSONImporterTwo::appendXMLDecl( rapidxml::xml_document<>* axdoc )
{
...
void 
JSONImporterTwo::buildXMLDoc( const map<string, CardDetails*, sortFunc>& mapDetails )
{
...
bool 
JSONImporterTwo::processSet( nlohmann::json& ajsonSet,
...
bool 
JSONImporterTwo::processCard( nlohmann::json& ajsonCard,
                              const string& aszSet,
...
bool 
JSONImporterTwo::updateCard( nlohmann::json& ajsonCard,
                             const string& aszSet,
...
bool 
JSONImporterTwo::updateAttr( const vector<string>& avecKeys,
                             const string& aszKey,
                             const string& aszVal,
                             CardDetails* rptDetails )
{
   int iSetKeyInd = ListHelper::List_Find(aszKey, avecKeys);
   if( iSetKeyInd != -1 )
   {
...
bool 
JSONImporterTwo::ensureUniqueAttr( std::string& rszDelimd,
